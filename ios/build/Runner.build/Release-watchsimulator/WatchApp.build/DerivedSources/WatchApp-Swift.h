...
#ifndef WATCHAPP_SWIFT_H
#define WATCHAPP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="WatchApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8WatchApp16RecordingManager")
...
@class CLLocation;
@interface RecordingManager (SWIFT_EXTENSION(WatchApp)) <CLLocationManagerDelegate>
...
SWIFT_CLASS("_TtC8WatchApp19WatchSessionManager")
...
@interface WatchSessionManager (SWIFT_EXTENSION(WatchApp)) <WCSessionDelegate>
